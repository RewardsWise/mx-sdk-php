...
/**
 * MonthlyCashFlowProfileRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MonthlyCashFlowProfileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MonthlyCashFlowProfileRequest';
    ...
    */
     ...
     *
     * @param bool|null $uses_estimated_goals_contribution Determines if the user uses estimated goals contribution.
     *
     * @return self
     */
