...
/**
 * SpendingPlanIterationItemCreateRequestBody Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SpendingPlanIterationItemCreateRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpendingPlanIterationItemCreateRequestBody';
    ...
    protected static array $openAPINullables = [
        ...
        'scheduled_payment_guid' => false,
        'top_level_category_guid' => false
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['planned_amount'] === null) {
            $invalidProperties[] = "'planned_amount' can't be null";
        }
     ...
     * Sets item_type
     *
     * @param float|null $item_type item_type
     *
     * @return self
     */
     ...
     * Sets planned_amount
     *
     * @param float $planned_amount planned_amount
     *
     * @return self
     */
    ...
    public function setScheduledPaymentGuid($scheduled_payment_guid)
    {
        if (is_null($scheduled_payment_guid)) {
            throw new \InvalidArgumentException('non-nullable scheduled_payment_guid cannot be null');
        }
    ...
    public function setTopLevelCategoryGuid($top_level_category_guid)
    {
        if (is_null($top_level_category_guid)) {
            throw new \InvalidArgumentException('non-nullable top_level_category_guid cannot be null');
        }
