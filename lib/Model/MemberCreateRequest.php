 ...
 */
class MemberCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MemberCreateRequest';
    ...
    protected static $openAPITypes = [
        ...
        'credentials' => '\OpenAPI\Client\Model\CredentialRequest[]',
        'id' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('skip_aggregation', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets credentials
     *
     * @return \OpenAPI\Client\Model\CredentialRequest[]
     */
     ...
     * Sets credentials
     *
     * @param \OpenAPI\Client\Model\CredentialRequest[] $credentials credentials
     *
     * @return self
     */
     ...
     *
     * @param bool|null $skip_aggregation skip_aggregation
     *
     * @return self
     */
    public function setSkipAggregation($skip_aggregation)
    {
        if (is_null($skip_aggregation)) {
            throw new \InvalidArgumentException('non-nullable skip_aggregation cannot be null');
        }
