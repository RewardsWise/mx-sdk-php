...
/**
 * ConnectWidgetResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConnectWidgetResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConnectWidgetResponse';
    ...
    {
        $this->setIfExists('connect_widget_url', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $connect_widget_url connect_widget_url
     *
     * @return self
     */
    public function setConnectWidgetUrl($connect_widget_url)
    {
        if (is_null($connect_widget_url)) {
            array_push($this->openAPINullablesSetToNull, 'connect_widget_url');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('connect_widget_url', $nullablesSetToNull);
            if ($index !== FALSE) {
