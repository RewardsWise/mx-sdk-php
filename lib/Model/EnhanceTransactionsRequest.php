...
/**
 * EnhanceTransactionsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EnhanceTransactionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnhanceTransactionsRequest';
    ...
    protected static array $openAPINullables = [
        'amount' => false,
        'description' => false,
        'extended_transaction_type' => false,
        'id' => false,
        'memo' => false,
    ...
    */
    ...
    public function setExtendedTransactionType($extended_transaction_type)
    {
        if (is_null($extended_transaction_type)) {
            throw new \InvalidArgumentException('non-nullable extended_transaction_type cannot be null');
        }
