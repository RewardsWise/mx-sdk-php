...
/**
 * TaggingResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TaggingResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaggingResponse';
    ...
    */
     ...
     * Sets tag_guid
     *
     * @param string|null $tag_guid tag_guid
     *
     * @return self
     */
    ...
    {
        if (is_null($tag_guid)) {
            array_push($this->openAPINullablesSetToNull, 'tag_guid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tag_guid', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $transaction_guid transaction_guid
     *
     * @return self
     */
    public function setTransactionGuid($transaction_guid)
    {
        if (is_null($transaction_guid)) {
            array_push($this->openAPINullablesSetToNull, 'transaction_guid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('transaction_guid', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
