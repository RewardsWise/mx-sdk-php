...
/**
 * SpendingPlanAccountResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SpendingPlanAccountResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpendingPlanAccountResponse';
    ...
    */
    ...
    public function setSpendingPlanGuid($spending_plan_guid)
    {
        if (is_null($spending_plan_guid)) {
            throw new \InvalidArgumentException('non-nullable spending_plan_guid cannot be null');
        }
