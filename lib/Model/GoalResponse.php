...
class GoalResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets guid
     *
     * @param string|null $guid Unique identifier for the goal. Defined by MX.
     *
     * @return self
     */
     ...
     *
     * @param string|null $projected_to_complete_at Date and time the goal is projected to be completed.
     *
     * @return self
     */
