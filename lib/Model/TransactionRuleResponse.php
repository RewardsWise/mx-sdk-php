...
/**
 * TransactionRuleResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TransactionRuleResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionRuleResponse';
    ...
    */
     ...
     *
     * @param string|null $match_description match_description
     *
     * @return self
     */
    public function setMatchDescription($match_description)
    {
        if (is_null($match_description)) {
            array_push($this->openAPINullablesSetToNull, 'match_description');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('match_description', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
