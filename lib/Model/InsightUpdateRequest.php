...
/**
 * InsightUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InsightUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsightUpdateRequest';
    ...
    */
    ...
    public function setHasBeenDisplayed($has_been_displayed)
    {
        if (is_null($has_been_displayed)) {
            throw new \InvalidArgumentException('non-nullable has_been_displayed cannot be null');
        }
    ...
    public function setIsDismissed($is_dismissed)
    {
        if (is_null($is_dismissed)) {
            throw new \InvalidArgumentException('non-nullable is_dismissed cannot be null');
        }
