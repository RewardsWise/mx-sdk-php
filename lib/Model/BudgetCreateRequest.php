...
/**
 * BudgetCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BudgetCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BudgetCreateRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['parent_guid'] === null) {
            $invalidProperties[] = "'parent_guid' can't be null";
        }
     ...
     * Sets category_guid
     *
     * @param string $category_guid Unique identifier of the category.
     *
     * @return self
     */
     ...
     * Sets parent_guid
     *
     * @param string $parent_guid Unique identifier of the parent budget. This is only required when creating a budget on a sub-category.
     *
     * @return self
     */
    public function setParentGuid($parent_guid)
    {
        if (is_null($parent_guid)) {
            throw new \InvalidArgumentException('non-nullable parent_guid cannot be null');
        }
     ...
     * Sets amount
     *
     * @param int|null $amount Amount of the budget.
     *
     * @return self
     */
